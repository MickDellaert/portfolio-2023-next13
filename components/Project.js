  ...
  return (
    <>
      <Link className="relative" href={`/project/${urlName}`}>
        <div className="grid-image-container rounded-2xl overflow-hidden">
          {/* <h1 className="text-xl font-bold">{name}</h1>
          <p>{description}</p> */}
          <Image
            className="rounded-xl grid-image"
            src={mainImage}
            alt={name}
            width={800}
            height={800}
          ...
          <div className="grid-overlay rounded-2xl ">
            <div className="grid-title text-3xl text-center font-black text-primary p-8">
